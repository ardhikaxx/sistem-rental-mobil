...
<div class="page-header">
    ...
    <a href="{{ route('employee.customers.create') }}" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Tambah Pelanggan</a>
</div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('employee.customers.show', $c) }}" class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></a>
                            <a href="{{ route('employee.customers.edit', $c) }}" class="btn btn-sm btn-outline-secondary"><i class="fas fa-edit"></i></a>
                        </td>
                    </tr>
                    @empty
