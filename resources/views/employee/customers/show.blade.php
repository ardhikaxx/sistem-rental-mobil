...
<div class="page-header">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('employee.customers.edit', $customer) }}" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit me-1"></i>Edit</a>
    </div>
</div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mb-2">
                    <a href="{{ route('employee.bookings.show', $b) }}">{{ $b->booking_code }}</a>
