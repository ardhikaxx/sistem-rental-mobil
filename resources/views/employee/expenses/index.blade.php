...
<div class="page-header">
    ...
    <a href="{{ route('employee.expenses.create') }}" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Tambah Pengeluaran</a>
</div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('employee.expenses.show', $e) }}" class="btn btn-sm btn-outline-primary" title="Detail"><i class="fas fa-eye"></i></a>
                        </td>
                    </tr>
                    @empty
