...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('employee.payments.index') }}">Kasir</a></li>
...
<div class="row g-3">
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-borderless mb-0">
                    <tr><th width="150">Kode Booking</th><td><a href="{{ route('employee.bookings.show', $payment->booking) }}">{{ $payment->booking->booking_code }}</a></td></tr>
