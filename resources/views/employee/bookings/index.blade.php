...
<div class="page-header">
    ...
    <a href="{{ route('employee.bookings.create') }}" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Tambah Booking</a>
</div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('employee.bookings.show', $b) }}" class="btn btn-sm btn-outline-primary" title="Detail"><i class="fas fa-eye"></i></a>
                            <a href="{{ route('employee.bookings.edit', $b) }}" class="btn btn-sm btn-outline-secondary" title="Edit"><i class="fas fa-edit"></i></a>
                        </td>
                    </tr>
                    @empty
