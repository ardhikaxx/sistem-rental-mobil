            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('owner.bookings.show', $p->booking) }}">{{ $p->booking->booking_code }}</a></td>
                        ...
                        <td>
                            <a href="{{ route('owner.payments.show', $p) }}" class="btn btn-sm btn-outline-primary" title="Detail"><i class="fas fa-eye"></i></a>
                        </td>
                    </tr>
                    @empty
